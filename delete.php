...
<html lang="en">
  <head>
    ...
    <title>Kirangle | Delete Broadcast</title>
  </head>
                    ...
                    <li class="nav-item ">
                      ...
                      <li class="nav-item active">
                          <a href="delete.php" class="nav-link">
                              ...
                              <p>Delete</p><span class="sr-only">(current)</span>
                          </a>
                      </li> 
                      <?php 
 ...
 <div class="container login-container">
            <div class="row">
               <div class="col col-sm-12 col-md-6 col-lg-6 login-form-1">
                  <div class="info">
                    <h1 class="display-4">DELETE A BROADCAST</h1>
                    <p class="lead">Please provide correct channel name and room number to delete the broadcasted item. </p>
                    <p class="lead">To ensure privacy, we delete a single-shared broadcast after a download, if you have multi-shared broadcast we keep it with us for 2 days </p>

                  </div>
                </div>
                <div class="col col-sm-12 col-md-6 col-lg-6 login-form-2">
                  <h1 class="display-3">DELETE YOUR BROADCAST</h1>
                      
                    <form action="func.php"  method="post"> <form>
                        <div class="form-group">
                            <input reuired type="text" name = "broadcastname" class="form-control" placeholder="Channel Name *"  />
                        </div>
                        <div class="form-group">
                            <input required type="text" name = "roomnumber" class="form-control" placeholder="Room Number *"  />
                        </div>
                        <div class="form-group">
                            <input type="submit" name = "delete" class="btnSubmit" value="Delete" />
                        </div>
