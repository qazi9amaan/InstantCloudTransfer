                ...
                <div class="col col-sm-12 col-md-6 col-lg-6 login-form-2">
                  <h1 class="display-3">DOWNLOAD YOUR FILE</h1>
                    ...
                    <form action="func.php"  method="post"  enctype= "multipart/form-data">
                        ...
                        <div class="form-group">
                            <input type="submit" id = "downloadingbtn" name = "download" class="btnSubmit" value="Download" />
                        </div>
...
<!-- Optional JavaScript -->
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
      ...
      <script>
          ...
          $(document).on('click', '#downloadingbtn', function(){  
            
              $("#downloadingbtn").attr("value", "Generating ...");
