<?php
    ...
    if(isset($_GET['searchforum']))
    {
        if(!empty($_GET['search'])){
            $owner =$_GET['user'];
            $search =$_GET['search'];
            $sql = "SELECT * FROM forumowner WHERE owner= '$owner' and forumname like '%$search%' ORDER BY id DESC";
                    ...
                    while($row = mysqli_fetch_array($result)){
                                ...
                                echo   '<div class="card visiter ">
	                                <div class="card-body ">
										...
										<a  href="forumviewhelper.php?id=" id = "'.$row['id'].'" class=" stretched-link "></a>
	                                </div>
                            </div>';
        ...
        if(isset($_POST['showallforums'])){
                $owner =$_POST['user'];
                $sql = "SELECT * FROM forumowner WHERE owner= '$owner' ORDER BY id DESC";
                        ...
                        while($row = mysqli_fetch_array($result)){
                         ...
                         echo   '<div class="card visiter">
	                                <div class="card-body ">
										...
										<a href="forumviewhelper.php?id='.$row['id'].'&forum='.$row['forumname'].'" class=" stretched-link "></a>
